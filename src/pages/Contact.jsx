      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Get in touch with us for quick and reliable appliance repair service
          </p>
        </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <p className="text-sm text-gray-600">Landline No</p>
                  <a
                    href={`tel:${BUSINESS_INFO.landline}`}
                    className="text-lg font-medium text-gray-800 hover:text-primary"
                  >
            ...
            <div className="mt-8 pt-8 border-t">
              <a
                href={`tel:${BUSINESS_INFO.phone}`}
                className="block w-full text-center bg-primary text-white py-3 rounded-lg hover:bg-secondary transition-colors font-semibold"
              >
